        ...
        <div className="collapse navbar-collapse d-flex" id="navbarScroll">
          <ul className="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" >
           ...
           Home
            ...
            <li className="nav-item">
              <div ><a className="nav-link tab2 m-2 p-2 rounded"  href={"/ProductList"}>New Products</a>
        </div>
          
            </li>
            <li className="nav-item "><a tabIndex="-1"  className="nav-link tab2 p-2 m-2 rounded" href={"/AddProduct"} id="navbarScrollingDropdown" role="button" >
              Sell Products
              </a>
            </li>
            <li className="nav-item "><a tabIndex="-1"  className="nav-link tab2 p-2 m-2 rounded" href={"/AddToCart"} id="navbarScrollingDropdown" role="button" >
             My Cart 
              </a>
            </li>
          </ul>
          ...
          <div align="center" className="rounded border d-flex pt-2 justify-content-center" style={{width:100,height:40,fontSize:15}}>
            <text className="">Hello User</text>
          </div>
        </div>
      </div>
    </nav>
